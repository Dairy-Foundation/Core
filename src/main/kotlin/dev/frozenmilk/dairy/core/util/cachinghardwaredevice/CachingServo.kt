...
open class CachingServo @JvmOverloads constructor(val servo: Servo,
	...
	override fun setPosition(position: Double) {
		...
		if (java.lang.Double.isNaN(cachedPosition) || Math.abs(cachedPosition - position) >= cachingTolerance || position <= 0.0 && !(cachedPosition <= 0.0) || position >= 1.0 && !(cachedPosition >= 1.0)) {
